...
|-----------|---------------|--------|
| Cache generator | ~/.claude/scripts/hooks/bochi-google-cache.sh | ✅ |
| launchd schedule | ~/Library/LaunchAgents/com.bochi.google-cache.plist | ✅ |
| S3 sync (push) | Included in bochi-google-cache.sh | ✅ |
| S3 sync (pull) | ~/.claude/scripts/hooks/bochi-s3-pull-on-read.sh | ✅ |
| cache/ directory | ~/.claude/bochi-data/cache/ | ✅ |
| Lightsail hook | hooks.json PreToolUse Read entry | ✅ |
